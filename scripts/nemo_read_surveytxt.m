function [XYZ] = nemo_read_surveytxt(filename, startRow, endRow)
%NEMO_READ_SURVEYTXT Convert Shore .txt to .mat-file
%
%   Occasionally a .mat file may not be available for a shore survey. If a .txt
%   file is available, a .mat file can be generated with this script.
%
%Import numeric data from a text file as column vectors.
%   [XYZ] = nemo_read_surveytxt(FILENAME) Reads data from
%   text file FILENAME for the default selection.
%
%   [XYZ] = nemo_read_surveytxt(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [XYZ] = nemo_read_surveytxt('NeMo_2016_09_XYZ_RDNAP.txt');
%
%   See also NEMO, TEXTSCAN.

% Auto-generated by MATLAB on 2016/12/07 09:31:49
