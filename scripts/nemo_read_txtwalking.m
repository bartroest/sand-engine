function [XYZ] = nemo_read_txtwalking(filename)
%NEMO_READ_TXTWALKING Read Shore Vlugtenburg-survey walking .txt-files and output a struct.
%
%   Reads land-based Vlugtenburg survey data.
%
%   Import numeric data from a text file as column vectors.
%   [X_RDM,Y_RDMZ_,NAPM] = nemo_read_txtwalking(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [X_RDM,Y_RDMZ_,NAPM] = nemo_read_txtwalking(FILENAME, STARTROW, ENDROW) Reads
%   data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [X_rdm,Y_rdmZ_,NAPm] = nemo_read_txtwalking('XYZ_RDNAP.txt',8, 10391);
%
%    See also NEMO, TEXTSCAN.

% Auto-generated by MATLAB on 2016/12/09 15:16:09
...
XYZ.X = cell2mat(raw(:, 1));
XYZ.Y = cell2mat(raw(:, 2));
XYZ.Z = cell2mat(raw(:, 3));
